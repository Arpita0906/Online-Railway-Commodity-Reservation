...
<body>
	...
	<div class="wrap">
		...
		<div  class=" well login">
			<form class="form-signin " method="post" action="alogin1.php">
		
			<table class="table" style="margin-bottom:4px;">
			
			<tr>
			<td style="border-top:0px;"><label> User Id</label></td>
			<td style="border-top:0px;"> <input type="text" name="user" class="input-block-level" placeholder="User Id"></td>
			</tr>
			<tr >
