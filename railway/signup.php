<?php
	...
	if($val==1){
	?>
	<h3>User id is not available.Try another one</h3
	<?php
	}
...
<body>
	...
	<div class="wrap">
		...
		<table>
		<tr>
			<td style="border-top:0px;"> User ID <font color=red>* </font></td>
			<td style="border-top:0px;">
			<input type="text" name="uid" class="input-block-level" placeholder="Enter the User ID" ><span id="fn"></span></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="border-top:0px;"><input type="text" name="lname" class="input-block-level" placeholder="Enter the Last name" ></td>
		</tr>
		<tr>
