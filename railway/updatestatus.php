		...
		<div class="span12 well">
			<div class="display" style="height:30px;">
				...
				<th style="width:120px; border-top:0px;"> Booking Id</th>
					<th style="width:70px;border-top:0px;"> Booking Date</th>
					...
					<th style="width:55px;border-top:0px;"> Delivery Status</th>
				</tr>
				</table>
			</div>
			<div class="display" style="margin-top:11px;overflow:auto;">
				...
				<?php 
				$tbl_name="booking";
						$ViewQuery="SELECT * FROM $tbl_name where dstatus='not delivered' AND pstatus='amount received'";
						$SrNo=0;
						$Execute=mysqli_query($conn,$ViewQuery);
						while ($DataRow=mysqli_fetch_array($Execute)) 
						{
							$status=$DataRow["dstatus"];
                            $date=$DataRow["doj"];
					...
					<td style=" width:100px;border-top:0px;"><?php echo $bid; ?></td>
					
					<td style="width:70px;border-top:0px;"><?php echo $date; ?></td>
					<td style="width:67px;border-top:0px;"><?php echo $pstatus; ?> </td>
					<td style="width:65px;border-top:0px;"><?php echo $amt; ?></td>
                    <td style="width:65px;border-top:0px;"><?php echo $pname; ?></td>
                    <td style="width:56px !important;border-top:0px;"><a lass="text-info" href="update.php?pid=<?php echo $bid; ?>"><?php echo $status; ?></a></td>
