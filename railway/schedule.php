...
<body>
	<div class="wrap">
		...
		<div class="header">
			...
			<div id="heading">
			<a href="index.php" style="font-size: 30px !important;">Railway Commodity Reservation System</a>
			</div>
		</div>
		<!-- Navigation bar -->
...
<!-- display result -->
		<div class="span12 well">
			...
			<div class="display" style="margin-top:0px;overflow:auto;">
				...
				{
				?>
				<tr class="text-info" style="background-color:#FF0000">
					<td style="color:#00FF00"> <? echo $row['Number'] ?> </td>
					<td> <? echo $row['Name'] ?> </td>
