...
//validation for name	
	...
	{	
		...
		//alert(""+charat);
		 ...
		 if( charat < 65 || charat > 91 || charat <97 || charat>123 )
		 {
			document.getElementById("ln").innerHTML="<br/><font color=red>LastName must be not start with number</font>";
			return false;
		 }
		else if(c.length < 3)
		{
...
// validation for answer of security question
	...
	function calculateAmt(){
        var inputF = parseFloat(document.getElementById("weight").value);
		var amt=inputF*50;
