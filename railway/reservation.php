		...
		<!-- display train -->
			<div class="span8 well">
				...
				<tr>
					...
					<th style="width:150px;border-top:0px;">Available Capacity(Kg)</th>
				</tr>
				</table>
				</div>
				...
				<tr class="text-error">
					...
					<a class="text-info" href="reser.php?tno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&weight=<?php echo $weight ?>"><b><?php echo $weight ?></b></a>
